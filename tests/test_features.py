...
from src.feature_pipeline.feature_eng import (
    add_data_features, frequency_encode, target_encode, drop_unused_columns, run_feature_engineering
)
...
"""
def test_load_and_split_data_creates_split(tmp_path):
...
def test_drop_duplicates_remmoves_dupes():
    df = pd.DataFrame({
...
def test_clean_and_merge_skips_when_city_missing():
    ...
    print("✅ Cleand & merge (no city_full) passed.")
...
"""
def test_and_date_features_extracts_parts():
