...
from src.feature_pipeline.feature_eng import add_data_features, drop_unused_columns
...
TRAIN_FE_PATH = PROJECT_ROOT / "data" / "processed" / "feature_eng_train.csv"
...
if TRAIN_FE_PATH.exists():
    ...
    TRAIN_FEATURE_COLUMNS = [c for c in _train_cols.columns if c != "price"]    # exclude price col
else:
