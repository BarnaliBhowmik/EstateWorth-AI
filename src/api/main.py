...
# Config
# ----------------------------
S3_BUCKET = os.getenv("S3_BUCKET", "housing-regression-ml-data")
...
TRAIN_FE_PATH = Path(load_from_s3("processed/feature_eng_train.csv", "data/processed/feature_eng_train.csv"))
